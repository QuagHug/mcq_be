...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Question
        fields = ['id', 'question_text', 'image_url', 'answers', 'taxonomies', 'updated_at']
...
class QuestionBankSerializer(serializers.ModelSerializer):
    ...
    def get_last_modified(self, obj):
        ...
        question_updated = localtime(latest_question.updated_at) if latest_question else None
    ...
    class Meta:
        model = QuestionBank
        fields = ['id', 'name', 'description', 'bank_id', 'is_child', 'created_by', 
                 'questions', 'question_count', 'last_modified']
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['id', 'name', 'description', 'image_url', 'created_by', 
                 'question_banks', 'created_at', 'updated_at']
        read_only_fields = ['created_by'] 