...
urlpatterns = [
    ...
    path('generate-distractors/', 
         views.generate_distractors, 
         name='generate-distractors'),
    path('questions/<int:question_id>/add-distractors/', 
         views.add_distractors_to_question, 
         name='add-distractors-to-question'),
    path('compare-tests/', views.compare_tests, name='compare-tests'),
    path('tests/<int:test_id>/similar-tests/', 
         views.find_similar_tests, 
         name='similar-tests'),
    path('courses/<int:course_id>/check-test-similarity/',
         views.check_test_similarity_before_creation,
         name='check-test-similarity-before-creation'),
]