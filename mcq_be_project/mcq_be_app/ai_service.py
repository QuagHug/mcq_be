...
class AIService:
    ...
    def generate_questions(self, context: str, num_questions: int = 1, taxonomy_level: str = "Remember", difficulty: str = "medium") -> List[Dict]:
        prompt = f"""
        ...
        response = self.client.chat.completions.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "You are an expert teacher creating multiple choice questions. Always return response in a JSON array format."},
